...
var b = [[1, 2, 3], [4, 6, 8]];
//relative to y = 0
let mirrorY = [[1, 0, 0], [0, -1, 0], [0, 0, 1]];
//use y = (max - min) / 2, average
//testing some maths, [[0, -2, 0], [0, -4, 0]] * mirrorY = [[0, 2, 0], [0, 4, 0]] but we want [[0, -4, 0], [0, -2, 0]]
//Solution: Just flip the rows of the matrix. No need for fancy matrix multiplication unless we want to rotate to a specific angle.
//To do a specific angle, we do v - R first where v is the vector or list of coordinates and R is the origin of rotation. Then we can multiply with a rotation matrix and add back R.
//So for what we want, just do Array.reverse()
